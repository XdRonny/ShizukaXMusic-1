    ...
    if GITHUB_REPO and OWNER:
        buttons.append(
            [
                ...
                InlineKeyboardButton(text=_["S_B_6"], url=f"ttps://te.legra.ph/file/8bc18c07df1361a31b88a.jpg"),
            ]
        )
    else:
        if GITHUB_REPO:
            buttons.append(
                [
                    InlineKeyboardButton(text=_["S_B_6"], url=f"https://te.legra.ph/file/8bc18c07df1361a31b88a.jpg"),
                ]
            )
        if OWNER:
            buttons.append(
